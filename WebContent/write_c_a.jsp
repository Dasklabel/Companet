	...
	<div class="container">
		...
		<form method="post" action="write_c_a_Action.jsp">
			<table class="table table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="제목" name="com_app_Title" maxlength="50"></td>
					</tr>
				</tbody>
			</table>
			<table class="table table-hover" style="text-align: center; border: 1px solid #dddddd">
					<tbody>
					<tr>
						<td><textarea class="form-control" placeholder="내용" name="com_app_Content" maxlength="3000" style="height: 350px;"></textarea></td>
					</tr>
				</tbody>
			</table>
