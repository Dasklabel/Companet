...
<body>
	<%
		...
		if(!userID.equals(comapp.getUserID())) {
			...
			if (request.getParameter("com_app_Title") == null || request.getParameter("com_app_Content") == null
					|| request.getParameter("com_app_Title").equals("") || request.getParameter("com_app_Content").equals("")) {
				PrintWriter script = response.getWriter();
				script.println("<script>");
				...
				int result = wcaDAO.update(Com_app_ID, request.getParameter("com_app_Title"), request.getParameter("com_app_Content"));
				if (result == -1) {
					PrintWriter script = response.getWriter();
					script.println("<script>");
