...
<div class="container">
		...
		<table class="table table-hover"
				...
				<tbody>
					...
					<tr>
						<td>내용</td>
						<td colspan="2" style="min-height: 200px; text-align: left;"><%= freepro.getFree_pro_Content().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
				...
				<div class="col-xs-1">
					<a href="free_pro.jsp" class="btn btn-primary" style="margin-right: 5px">목록</a>
				</div>
			<%
				if(userID != null && userID.equals(freepro.getUserID())) {
			%>
				<div class="col-xs-1">
					<a href="update_f_p.jsp?free_pro_ID=<%= Free_pro_ID %>"
				class="btn btn-primary" style="margin-right: 5px" >수정</a>
				</div>
				<div class="col-xs-1">
					<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="delete_f_p_Action.jsp?free_pro_ID=<%= Free_pro_ID %>"
