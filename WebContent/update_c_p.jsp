...
<body>
	...
	<div class="container">
		<div class="row">
		<form method="post" action="update_c_p_Action.jsp?com_pro_ID=<%= Com_pro_ID %>">
			<table class="table table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="제목" name="com_pro_Title" maxlength="50" value="<%= compro.getCom_pro_Title()%>"></td>
					</tr>
					<tr>
						<td><textarea class="form-control" placeholder="내용" name="com_pro_Content" maxlength="3000" style="height: 350px;"><%= compro.getCom_pro_Content()%></textarea></td>
					</tr>
				</tbody>
			</table>
