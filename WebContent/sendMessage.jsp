	...
	<div class="container">
		<div class="row">
			<div class="col-xs-1" style="margin-right: 50px; margin-top:20px; margin-bottom:20px">
				<a href="sendMessage.jsp"><button class="btn btn-warning">보낸 쪽지함</button></a>
			</div>
			<div class="col-xs-1"style="margin-top:20px; margin-bottom:20px">
				<a href="receiveMessage.jsp"><button class="btn btn-default">받은 쪽지함</button></a>
			</div>
		</div>
	</div>
	<div class="container">
		<div class="row">
			<table class="table table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<%
						...
						ArrayList<Message> list = messageDAO.getSend_List(pageNumber);
					...
					%>
						...
						<td>
						<a
							href="view_sendMessage.jsp?ID=<%=list.get(i).getID()%>"><%=list.get(i).getTitle().replaceAll(" ", "&nbsp;")
							.replaceAll("<", "&lt;")
			...
			<%
				if (pageNumber != 1) {
			%>
			<a href="sendMessage.jsp?pageNumber=<%=pageNumber - 1%>"
