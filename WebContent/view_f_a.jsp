        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownId">
              ...
              <a class="dropdown-item active" href="free_app.jsp">프리랜서</a>
            </div>
          </li>
          <li class="nav-item dropdown">
		...
		<table class="table table-hover"
				...
				<tbody>
					<tr>
						...
						<td colspan="2"><%= freeapp.getFree_app_Title().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td>
					</tr>
					<tr>
						<td>작성자</td>
						<td colspan="2"><%= freeapp.getUserID() %></td>
					</tr>
					<tr>
						<td>작성일자</td>
						<td colspan="2"><%= freeapp.getFree_app_Date().substring(0, 11) + freeapp.getFree_app_Date().substring(11, 13) + ":" + freeapp.getFree_app_Date().substring(14, 16) %></td>
					</tr>
					<tr>
						<td>내용</td>
						<td colspan="2" style="min-height: 200px; text-align: left;"><%= freeapp.getFree_app_Content().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
				...
				<div class="col-xs-1">
					<a href="free_app.jsp" class="btn btn-primary" style="margin-right: 5px">목록</a>
				</div>
			<%
				if(userID != null && userID.equals(freeapp.getUserID())) {
			%>
				<div class="col-xs-1">
					<a href="update_f_a.jsp?free_app_ID=<%= Free_app_ID %>"
				class="btn btn-primary" style="margin-right: 5px" >수정</a>
				</div>
				<div class="col-xs-1">
					<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="delete_f_a_Action.jsp?free_app_ID=<%= Free_app_ID %>"
