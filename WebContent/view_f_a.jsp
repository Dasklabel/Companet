		...
		<div class="row">
			<table class="table table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						<td>내용</td>
						<td colspan="2" style="min-height: 200px; text-align: left;"><%= freeapp.getFree_app_Content().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td>
					</tr>
				</tbody>
			</table>
			...
			%>
					<a href="update_f_a.jsp?free_app_ID=<%= Free_app_ID %>" class="btn btn-primary">수정</a>
					<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="delete_f_a_Action.jsp?free_app_ID=<%= Free_app_ID %>" class="btn btn-primary">삭제</a>
			<%
				}
			%>
		</div>
