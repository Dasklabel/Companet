...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
	...
	<div class="container">
		...
		<form method="post" action="write_f_p_Action.jsp">
			<table class="table table-hover" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="2" style="background-color: #eeeeee; text-align: center;">인력제공-프리랜서</th>					
					</tr>
				</thead>
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="제목" name="free_pro_Title" maxlength="50"></td>
					</tr>
				</tbody>
			</table>
			<table class="table table-hover" style="text-align: center; border: 1px solid #dddddd">
					<tbody>
					<tr>
						<td><textarea class="form-control" placeholder="내용" name="free_pro_Content" maxlength="3000" style="height: 350px;"></textarea></td>
					</tr>
				</tbody>
			</table>
