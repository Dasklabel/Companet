		...
		<div class="row">
			<table class="table table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						<td>내용</td>
						<td colspan="2" style="min-height: 200px; text-align: left;"><%= compro.getCom_pro_Content().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td>
					</tr>
				</tbody>
			</table>
			<a href="com_pro.jsp" class="btn btn-primary">목록</a>
			<%
				if(userID != null && userID.equals(compro.getUserID())) {
			%>
					<a href="update_c_p.jsp?com_pro_ID=<%= Com_pro_ID %>" class="btn btn-primary">수정</a>
					<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="delete_c_p_Action.jsp?com_pro_ID=<%= Com_pro_ID %>" class="btn btn-primary">삭제</a>
			<%
				}
			%>
		</div>
