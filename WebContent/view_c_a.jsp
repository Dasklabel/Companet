	...
	<div class="container">
		...
		<table class="table table-hover"
				...
				<tbody>
					...
					<tr>
						<td>내용</td>
						<td colspan="2" style="min-height: 200px; text-align: left;"><%= comapp.getCom_app_Content().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
				...
				<div class="col-xs-1">
					<a href="com_app.jsp" class="btn btn-primary" style="margin-right: 5px">목록</a>
				</div>
			<%
				if(userID != null && userID.equals(comapp.getUserID())) {
			%>
				<div class="col-xs-1">
					<a href="update_c_a.jsp?com_app_ID=<%= Com_app_ID %>"
				class="btn btn-primary" style="margin-right: 5px" >수정</a>
				</div>
				<div class="col-xs-1">
					<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="delete_c_a_Action.jsp?com_app_ID=<%= Com_app_ID %>"
